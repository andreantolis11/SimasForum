...
public class ThreadControllerTest {
    ...
    void showDetail_byId() throws Exception{
        Thread mockThread = (new Thread(0, "Thread about this", "The content of the thread is", 15, null));
...
//                .andExpectAll(status().isNotFound(),content().string(containsString("")));
    ...
    void addThread_withSampleData_ok() throws Exception {
    	Thread mockThread = new Thread(1, "ss", "sss", 15, LocalDate.now());
...
//                content().string(containsString("Thread about this"))
    ...
    void showDashboardByDate() throws Exception {
    	List<Thread> mockThread = List.of(new Thread(1, "Thread about this", "The content of the thread is", 15, LocalDate.now()));
